...
Snapshot <- openxlsx2::wb_to_df(
  ...
  detectDates = TRUE
    ...
    Hardware = str_extract(str_to_lower(AnalysisLabel), "\\b[a-z]{1,4}\\b")
  ) |> unite(
  col = "CombID",
  sep = ".",
...
Missingness for 12month PROMs (represented by VR12, common to all cohorts) is captured in @fig-fuprom-miss.
