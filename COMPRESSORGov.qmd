...
A static registry snapshot was retrieved and formatted based on the fixed date of preparation of the snapshot (17-Sep-2025).
...
specific_snapshot <- get_specific_snapshot("20250917")
